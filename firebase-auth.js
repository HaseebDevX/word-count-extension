const e = _isFirebaseServerApp
const i = SDK_VERSION
const n = getApp
const r = registerVersion
const t = _registerComponent
...
const getExperimentalSetting = (e) => {
  var t
...
const l = { PHONE: "phone", TOTP: "totp" },
  ...
  f = { LINK: "link", REAUTHENTICATE: "reauthenticate", SIGN_IN: "signIn" },
  m = {
...
function _errorWithCustomMessage(e, t, r) {
  const n = Object.assign(Object.assign({}, _()), { [t]: r })
...
async function _reloadWithoutSaving(e) {
  ...
  const r = e.auth,
    ...
    i = await _logoutIfInvalidated(e, getAccountInfo(r, { idToken: n }))
...
class AuthImpl {
  ...
  async initializeCurrentUserFromIdToken(e) {
    try {
      const t = await getAccountInfo(this, { idToken: e }),
...
const P = { USER_NOT_FOUND: "user-not-found" }
...
async function signInAnonymously(t) {
  ...
  const i = await signUp(n, { returnSecureToken: !0 }),
      ...
      this.shouldResolveImmediately(t) && isV2(_window().grecaptcha)
        ...
        : new Promise((r, n) => {
            ...
            _loadJS(
              ...
              })()}?${querystring({ onload: N, render: "explicit", hl: t })}`
            ).catch(() => {
...
const D = { theme: "light", type: "image" }
...
const G = { location: "yes", resizable: "yes", statusbar: "yes", toolbar: "no" }
class AuthPopup {
  constructor(e) {
...
const authIdTokenMaxAge = getExperimentalSetting("authIdTokenMaxAge") || 300
let J = null
    ...
    if (location.origin === e.origin) {
      const t =
        ...
        async (e) => {
          ...
          if (r && r > authIdTokenMaxAge) return
